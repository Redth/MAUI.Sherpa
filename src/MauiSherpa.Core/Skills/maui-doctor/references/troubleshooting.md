...
**⏱️ Check this first - many errors are NOT what they seem.**
...
| "Xcode license" error | Unknown | License reset after update | `sudo xcodebuild -license accept` |
| "workload not found" | Workload missing | Wrong SDK version active | Check `dotnet --info` for SDK path |

**Rule: Verify with direct path check before reinstalling anything.**
...
ls "C:\Program Files\Microsoft\"        # Windows

# Is Android SDK really missing?
